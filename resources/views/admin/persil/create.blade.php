...
@section('content')
<div class="container">
	<h1 class="h3 mb-3">Tambah Persil</h1>
	<form method="POST" action="{{ route('admin.persil.store') }}">
		@csrf
		<div class="mb-3">
			<label class="form-label">Kode Persil</label>
			<input name="kode_persil" class="form-control" value="{{ old('kode_persil') }}">
